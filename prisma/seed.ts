    ...
    await db.storeSettings.create({
      data: {
        ...
        testimonialsData: JSON.stringify([
          { id: 't1', name: 'Sari Dewi', avatar: 'SD', rating: 5, text: 'Kualitas bahan sangat bagus dan pengiriman cepat! Sudah langganan sejak tahun lalu. Recommended banget!', location: 'Jakarta' },
          { id: 't2', name: 'Budi Santoso', avatar: 'BS', rating: 5, text: 'Harga terjangkau dengan kualitas premium. Customer service juga sangat responsif. Top!', location: 'Bandung' },
          { id: 't3', name: 'Anisa Rahma', avatar: 'AR', rating: 4, text: 'Koleksi hijabnya lengkap dan modern. Packing rapi dan aman. Pasti beli lagi disini!', location: 'Surabaya' },
        ]),
        brandPartners: JSON.stringify([
